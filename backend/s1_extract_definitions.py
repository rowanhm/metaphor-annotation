...
from backend.common.common import info, warn, flatten, save_pickle
...
def main():
    ...
    save_pickle(concepts_to_definitions_py_file, definitions)
    save_pickle(example_sentences_file_princeton, examples)
